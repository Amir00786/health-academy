...
(function () {
  ...
  const SHARED = {
    ...
    'nav.leadership': { en: 'Leadership', ar: 'القيادة' },
    ...
    'nav.dd.founder.title': { en: 'Founder', ar: 'المؤسس' },
    'nav.dd.founder.sub': { en: 'Meet the person behind iHealth Academy', ar: 'تعرف على الشخص وراء أكاديمية آي هيلث' },
    'nav.dd.execleadership.title': { en: 'Executive Leadership', ar: 'القيادة التنفيذية' },
    'nav.dd.execleadership.sub': { en: 'The team steering the academy', ar: 'الفريق الذي يقود الأكاديمية' },
    'nav.dd.advisors.title': { en: 'Board of Advisors', ar: 'مجلس المستشارين' },
    'nav.dd.advisors.sub': { en: 'Guidance from industry experts', ar: 'إرشاد من خبراء الصناعة' },
    'nav.dd.directors.title': { en: 'Academy Directors', ar: 'مدراء الأكاديمية' },
    'nav.dd.directors.sub': { en: 'Leading each department', ar: 'قيادة كل قسم' },
    'nav.dd.foundingteam.title': { en: 'Join Our Founding Team', ar: 'انضم إلى فريقنا المؤسس' },
    'nav.dd.foundingteam.sub': { en: 'Open roles — help us build this', ar: 'أدوار متاحة — ساعدنا في بنائها' },
