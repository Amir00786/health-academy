...
async function saveAllProgress(){
  try{ await window.storage.set("insurance-dept-progress", JSON.stringify(progress)); }
  catch(e){ /* ignore */ }
}
async function loadAllProgress(){
  try{
    const r = await window.storage.get("insurance-dept-progress");
...
document.getElementById("quizContinueBtn").addEventListener("click", ()=>{ showView("landing"); renderLanding(); });
document.getElementById("videoBackBtn").addEventListener("click", ()=>{ showView("landing"); renderLanding(); });
...
document.getElementById("practiceBackBtn").addEventListener("click", ()=>{ showView("landing"); renderLanding(); });
