window.I18N_PAGE_DICT = {
  ...
  'pcert.reviewBtn': { en: 'Review before confirming <i class="fi fi-rr-arrow-small-right"></i>', ar: 'مراجعة قبل التأكيد <i class="fi fi-rr-arrow-small-left"></i>' },
  ...
  'pcert.editBtn': { en: '<i class="fi fi-rr-arrow-small-left"></i> Edit', ar: '<i class="fi fi-rr-arrow-small-right"></i> تعديل' },
