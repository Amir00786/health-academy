window.I18N_PAGE_DICT = {
      'fyp.tag': { en: 'Find your path', ar: 'اكتشف مسارك' },
      'fyp.h1': { en: 'Two moments,<br>one quiz.', ar: 'لحظتان،<br>اختبار واحد.' },
      'fyp.desc': { en: "Whether you're deciding if — and how — to enter medicine, or you're already an intern ranking residency programs, this short quiz scores your answers against real iHealthAcademy tracks and specialties, not just a general list.", ar: 'سواء كنت تقرر إن كنت ستدخل الطب — وكيف، أو كنت متدربًا يرتب برامج الإقامة، هذا الاختبار القصير يقيّم إجاباتك مقارنة بمسارات وتخصصات حقيقية في أكاديمية آي هيلث، وليس مجرد قائمة عامة.' },
      'fyp.stage1Tag': { en: 'Stage 01', ar: 'المرحلة 01' },
      'fyp.stage1Title': { en: 'Before Medical School', ar: 'قبل كلية الطب' },
      'fyp.stage1Desc': { en: 'Secondary school or pre-med undergrad, deciding whether medicine is right for you — and which path in health care actually fits.', ar: 'طالب ثانوية أو مرحلة ما قبل الطب، يقرر ما إذا كان الطب مناسبًا له — وأي مسار في الرعاية الصحية يناسبه فعلًا.' },
      'fyp.stage1Meta': { en: '28 questions <i class="fi fi-sr-arrow-small-right"></i> top 10 health paths <i class="fi fi-sr-arrow-small-right"></i>', ar: '28 سؤالًا <i class="fi fi-sr-arrow-small-right"></i> أفضل 10 مسارات صحية <i class="fi fi-sr-arrow-small-right"></i>' },
      'fyp.stage2Tag': { en: 'Stage 02', ar: 'المرحلة 02' },
